    ...
    <div id="detail-container">
        <div class="goods_details_img">
            ...
            <div class="goods_details_img_list">
                <img src="../../image/goods_img1.jpg" @click="changeImg"/>
                <img src="../../image/goods_img2.jpg" @click="changeImg"/>
                <img src="../../image/goods_img3.jpg" @click="changeImg"/>
                <img src="../../image/goods_img4.jpg" @click="changeImg"/>
                <img src="../../image/goods_img5.jpg" @click="changeImg"/>
            </div>
        </div>
        ...
        <div class="goods_details">
            ...
            <div class="goods_details_show_img">
                <img src="../../image/show_img1.jpg"/>
                <img src="../../image/show_img2.jpg"/>
                <img src="../../image/show_img3.jpg"/>
                <img src="../../image/show_img4.jpg"/>
                <img src="../../image/show_img5.jpg"/>
            </div>
            <div class="goods_details_title">

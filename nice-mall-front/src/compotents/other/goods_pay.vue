<template>
    <div id="pay-container">
        ...
        <div class="pay_title">商品清单
            <router-link to="/other_container/goods_order"><span>返回购物车修改商品</span></router-link>
        </div>
        <div class="goods">
            <table border="1">
                <tr>
                ...
                <tr>
                    <td>
                        <img src="../../image/goods1.jpg"/>
                        <span>拉夏贝尔旗下拉贝缇春新品女韩版宽松学生百搭牛仔外套</span>
                    </td>
                    <td>160/84A</td>
                    <td>¥299</td>
                    <td>1</td>
            ...
            <div class="pay_desc">
                <span>运费： 免运费</span>
                <span>已享受优惠： - ¥20</span>
                <span>本组商品金额：<span style="color: #fe5745">¥123</span></span>
            </div>
        </div>
        ...
        <div class="pay">
            ...
            <div class="pay_order">
                <div>
                    <span>商品金额： ¥143</span>
                    <span>优惠券优惠： - ¥20</span>
                    <span style="font-size: 20px;color: #fe5745"><b>待支付：</b> ¥123</span>
